    ...
    render() {
        ...
        return (
            ...
            <div style={{ position: 'relative' }}>
                ...
                >
                    <span>社区</span>
                    <span className="iconfont icon-shuaxin-sy" style={{marginLeft:"2vw",fontSize:'12px',marginTop:'2vh'}}></span>
                </NavBar>
                <div srtyle={{backgroundColor:"red",height:"7vh",width:"100vw",position:"fixed",top:0}}>
                <SearchBar placeholder="Search" maxLength={8} style={{width:'90vw',float:"left",position:"fixed",top:"7%"}}/>
                <Link to="/add"><span className="iconfont icon-add-sy" style={{fontSize:'35px',color:'black',position:"fixed",top:"7%",left:"90%",float:"left"}}></span></Link>
                </div>
                
                <div style={{height:'20%',background:'#fff',color:'black',marginTop:"7vh"}}>
